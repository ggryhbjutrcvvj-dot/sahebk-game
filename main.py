...
# --- 2. بنك الأسئلة والتلميحات القوية والمكبرة جداً ---
QUESTIONS_BANK = {
    "أفلام وسينما مصرية": [
...
# --- 3. قائمة عقابات عجلة العقاب الفكاهية ---
PUNISHMENTS_LIST = [
...
def load_data():
    if os.path.exists(DATA_FILE):
        try:
            ...
            pass
    return {"users": {}, "groups": {}, "friend_requests": {}, "friends": {}}
...
if "user" not in st.session_state:
    ...
    st.session_state.user = {"id": user_id, "name": f"لاعب_{user_id[1:]}", "score": 0}
...
# --- 5. التنسيق البصري والكرتوني (CSS) ---
st.markdown("""
    <style>
...
# ==========================================
# 🟢 1. واجهة الدخول بحجم الصورة (Welcome Screen)
# ==========================================
